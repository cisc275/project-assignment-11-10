...
public class Constants implements Serializable {
	...
	public final static String QUIZ_TO_FIRST_OPTION = "Press the A key if ";
	public final static String QUIZ_TO_SECOND_OPTION = "Press the B key if ";
	public final static String QUIZ_TO_THIRD_OPTION = "Press the C key if ";
	public final static String QUIZ_FIRST_OPTION = "A. ";
	public final static String QUIZ_SECOND_OPTION = "B. ";
	public final static String QUIZ_THIRD_OPTION = "C. ";
